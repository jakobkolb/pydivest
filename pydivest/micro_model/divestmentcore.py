...
class DivestmentCore:
    def __init__(self,
        ...
        self.n_trajectory_output = False
    ...
    def economy_dot_leontief(self, x0, t):
        ...
        try:
            ...
            print((
                f'income is negative, X_R: {X_R}, X_d: {X_d}, X_c: {X_c}, \n '
                f'K_d: {K_d}, K_c: {K_c} , G = {G}, C = {C} \n '
                f'r_c = {self.r_c}, r_d = {self.r_d}, w = {self.w}, R = {self.R} \n '
                f'investment decisions: \n {self.investment_decisions} \n '
                f'income: \n {self.income} \n'
                f'clean investment: \n {self.investment_clean} \n'
                f'dirty investment: \n {self.investment_dirty}'))
    ...
    def get_network_trajectory(self):
        ...
        columns = self.n_trajectory[0]
        df = pd.DataFrame(data=self.n_trajectory[1:], columns=columns)
...
if __name__ == '__main__':
    ...
    fig, axes2d = mp.subplots(nrows=2, ncols=3)
    axes = [item for sublist in axes2d for item in sublist]
