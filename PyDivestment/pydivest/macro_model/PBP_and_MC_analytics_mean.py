...
def calc_rhs(interaction=1):
    ...
    rs, delta, pi, kappac, kappad, xi = s.symbols('s delta pi kappa_c, kappa_d xi',
                                                  positive=True, real=True)
    # solow residuals of clean and dirty sector, pre factor for resource cost, energy efficiency, initial resource stock
